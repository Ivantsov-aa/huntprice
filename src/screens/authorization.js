                        ...
                        <View style={{ alignItems: 'center', marginBottom: 50 }}>
                            ...
                            <TouchableOpacity activeOpacity={0.9} onPress={handleSubmit(onSubmit)}>
                                <View style={styles.buttonContainerLogIn}>
                                    <DefaultHeader style={styles.buttonLogIn}>Войти</DefaultHeader>
                                </View>
                            </TouchableOpacity>
                            <DefaultText style={{ marginBottom: 10, fontSize: 12, lineHeight: 15, color: darkModeEnabled ? '#fff' : '#002845' }}>Ещё нет аккаунта?</DefaultText>
